...
def parse_args():
    ...
    parser.add_argument("--api-url", type=str, default="http://localhost:8000/v1/chat/completions", help="ASR API endpoint (OpenAI-compatible)")
...
def main():
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=num_threads) as executor:
        ...
        if not silence:
            pbar = tqdm(total=len(future_dict), desc="Calling Qwen3-ASR API")
